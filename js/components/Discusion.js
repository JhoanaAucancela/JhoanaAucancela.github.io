...
var Discusion = React.createClass({
    propTypes : {
                    ...
                    <div className="Discussion-top">
                        <div className="DiscussionAuthor">
                            <span className="DiscussionAuthor-name">
                                ...
                                <a href={this.props.user.avatar} title="Ver avatar" target="_blank">{this.props.user.name}</a>
                            </span>
                        </div>
                        <div className="">
                        ...
                        <div className="Discussion-bottomLeft">
                            ...
                            {function(){
                                if(this.props.level < 3){
                                    return (
                                        <span>
                                            <span onClick={this._onReply} className="icon-reply Discussion-reply">Comentar</span>
                                            <span className="Discussion-comments">{this.state.answers.length} Comentarios</span>
                                        </span>
                                    )
                                }
                            }.bind(this)()}
