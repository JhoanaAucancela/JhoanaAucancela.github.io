...
var DiscusionUser = React.createClass({
    ...
    render : function(){
        ...
        if(this.state.active){
            form = (<form onSubmit={this._onSubmit} className="DiscusionUser" key={this.state.active}>
                <label className="label_A">Ingresa tu nombre de usuario</label>
                <input 
                    type="text" 
                    name="name"
                    className="input_A"
